...
export const appTemplate = (clientName , email, companyName,subject ,offerDescription) => `<!DOCTYPE html>
<html>
<head>
  <style>
    body {
...
<body>
  <div class="email-container">
    ...
    <div class="email-body">
      ...
      <p>there is an application ${subject === subjects.SEND_APP? "sent" : "canceled"} for the offer " ${offerDescription} "</p>
      <h2 class="activation-button">By ${clientName} his email ${email}</h2>
      <p>${email} quickly.</p>
      <p>Best regards,<br>Social Media Team</p>
    </div>
    <div class="email-footer">
